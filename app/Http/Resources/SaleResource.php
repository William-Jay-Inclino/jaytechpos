...
class SaleResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'amount_tendered' => $this->when($this->amount_tendered !== null, (float) $this->amount_tendered),
            'deduct_from_balance' => $this->when($this->deduct_from_balance !== null, (float) $this->deduct_from_balance),
